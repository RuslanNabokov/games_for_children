...
export const puzzles: Puzzle[] = [
  ...
  /* Этап 3 */
  {
    ...
    questions: [
      ...
      },
      {
        ...
        title: "Ядро",
        type: "guess",
        prompt: "Как называется часть семени, которую мы едим?",
        answer: "ядро",
        placeholder: "Введите слово",
      },
      {
      ...
      },
      {
        ...
        type: "guess",
        prompt:
          "Как называют специалиста, который занимается изучением вопросов экологии и решением важных экологических задач",
        answer: "эколог",
        placeholder: "Введите слово",
      },
    ],
...

  {
    ...
    questions: [
      {
        type: "sequence",
        images: "/assets/brushing_teeth.png",
        prompt: "Упорядочи шаги чистки зубов",
        steps: [
          "Взять зубную щётку",
          "Нанести зубную пасту",
          "Чистить круговыми движениями",
          "Полоскать рот водой",
          "Промыть щётку и убрать",
        ],
    ...
    questions: [
      {
        ...
        type: "guess",
        prompt:
          "Реши ребус на картинке и напиши, что нужно взять с собой в дождь.",
